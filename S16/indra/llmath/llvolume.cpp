...
const F32 HOLLOW_MAX = 0.99f; // Kirsten
const F32 HOLLOW_MAX_SQUARE	= 0.99f; // Kirsten
...
const F32 HOLE_X_MIN= 0.02f;
const F32 HOLE_X_MAX= 1.0f; //kirsten

const F32 HOLE_Y_MIN= 0.02f;
const F32 HOLE_Y_MAX= 0.9f; //kirsten
