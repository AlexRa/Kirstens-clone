...
void LLPanelObject::getState( )
{
	...
	BOOL advanced_cut_visible		= TRUE; //Kirsten
	...
	BOOL advanced_is_slice = FALSE; //kirsten
	...
	case MI_SPHERE:
		...
		advanced_is_slice		= FALSE; //kirsten
	...
	case MI_BOX:
		advanced_cut_visible	= TRUE; //kirsten
	...
	{
		mSpinHollow->setMinValue(0.f);
		mSpinHollow->setMaxValue(99.f); //kirsten
	}
	...
	if (advanced_cut_visible)
	{
		if (advanced_is_dimple)
		{
            ...
            childSetVisible("advanced_slice", FALSE);  //kirsten
        }
		else if (advanced_is_slice) //kirsten
		{
...
void LLPanelObject::getVolumeParams(LLVolumeParams& volume_params)
{
	...
	{
		if (hollow > 0.99f) hollow = 0.99f; //kirsten
	}
