...
const F32 DEFAULT_MAX_PRIM_SCALE = 128.f; //Kirsten OL scale 128 1/4 region seems sensible (depends on servers )
const F32 MIN_PRIM_SCALE = 0.001f; // Kirsten Nano Prim (stops it snapping back! )
