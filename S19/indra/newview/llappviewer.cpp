...
const char* const VIEWER_WINDOW_CLASSNAME = "Kirstens S19";
...
bool LLAppViewer::init()
{
	...
	gDirUtilp->initAppDirs("Kirstens S19");
    ...
    gCurrentVersion = llformat("%s %d.%d.%d.%d", 
        KL_CHANNEL,                                      //gSavedSettings.getString("VersionChannelName").c_str(), 
        LL_VERSION_MAJOR, 
        LL_VERSION_MINOR, 
        LL_VERSION_PATCH, 
        LL_VERSION_BUILD );
...
{	
	...
	gSavedSettings.setString("VersionChannelName", KL_CHANNEL);
...
void LLAppViewer::idle()
{
...

	{
		...
		if (viewer_stats_timer.getElapsedTimeF32() >= SEND_STATS_PERIOD && !gDisconnected)
		{
			...
			// send_stats(); // Kirsten no stats send for s19 viewer.
