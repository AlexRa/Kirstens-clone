...
#include "llfloaterhud.h" //KL include to use radar scanner see line llFloaterHud::updater (this file)
...
//							AUDIO_STEP_LO_GAIN, AUDIO_STEP_HI_GAIN );
	...
	mRoot.updateWorldMatrixChildren();
	LLFloaterHUD::updater();  // KL radar ViewerObject avatar hence radar only registers when an agent moves :) see floaterhud.cpp
