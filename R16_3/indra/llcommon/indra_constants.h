...
// CG 2008-06-05
 #define PHYSICS_TIMESTEP (1.f / 45.f) //OL experiment :) Kirsten in physics

const F32 COLLISION_TOLERANCE = 0.0f;
const F32 HALF_COLLISION_TOLERANCE = COLLISION_TOLERANCE * 0.0f; //eeps
...
const U32 DEFAULT_MAX_REGION_WIDE_PRIM_COUNT = 45000; //Kirsten
...
const LLUUID LL_UUID_ALL_AGENTS("44e87126-e794-4ded-05b3-7c42da3d5cdb"); // kirsten used in 3dx server now!

// Governor Linden's agent id.
const LLUUID GOVERNOR_LINDEN_ID("d3fbbce3-9fca-4a26-bd3c-7485f91f148d"); // sakai openlife
const LLUUID REALESTATE_LINDEN_ID("d3fbbce3-9fca-4a26-bd3c-7485f91f148d");

// Maintenance's group id.
const LLUUID MAINTENANCE_GROUP_ID("25074a66-1b6c-4770-846a-7c767fa629cb"); // kirsten openlife
...
const F32 SCAN_MAX_RADIUS = 500.f;
