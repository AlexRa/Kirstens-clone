 ...
 * @brief Handles "URL3DX fragments" like Bubble/123/45 for
...
// "openlife://simname/x/y/z" -> "simname/x/y/z"
// (actually .*//foo -> foo)
// static
...
{
	std::string url;
	if (sInstance.mParseState == PARSE_OK)  // Kirsten
	{
		url = llformat("openlife://%s/%d/%d/%d/",
