...
//-----------------------------------------------------------------------------
std::string LLAgent::getURL3DX() const
{
	std::string url3DX;
	LLViewerRegion *regionp = getRegion();
	if (regionp)
	{
		...
		url3DX = LLURLDispatcher::buildURL3DX(regionp->getName(), x, y, z);
	}
	return url3DX;
}
...
void LLAgent::setTeleportState(ETeleportState state)
{
	...
	{
		// We're outa here. Save "back" url3DX.
		mTeleportSourceURL3DX = getURL3DX();
	}
}
