...
public:
	static bool isURL3DX(const std::string& url);
		// Is this any sort of openlife:// or ol:// URL?

	static bool isURL3DXCommand(const std::string& url);
		// Is this a special openlife://app/ URL?
	...
	static bool dispatch(const std::string& url, bool from_external_browser);
		...
		// Handles:
		//   openlife://RegionName/123/45/67/
		//   openlife:///app/agent/3d6181b0-6a4b-97ef-18d8-722652995cf1/show
		//   ol://app/foo/bar
	...
	static std::string buildURL3DX(const std::string& regionname, S32 x, S32 y, S32 z);
		//   builds: http://url3DX.com/openlife/RegionName/x/y/z/
};
