		...
		switch (mStatus)
		{
			...
			default:
				...
				mStatusMessage =
					...
					" \n"
					"Please check http://openlifegrid.com/ \n"
					"to see if there is a known problem with the service.";

				mStatusURI = "http://openlifegrid.com/";
				/*
				mStatusMessage =
					"Despite our best efforts, something unexpected has gone wrong.\n"
...
{
	std::string message;
	std::string uri = "http://openlifegrid.com/WorldPortal/tabid/331/Default.aspx";
	...
	switch (code)
	{
		case CURLE_COULDNT_RESOLVE_HOST:
			message =
				...
				"Please verify that you can connect to the www.openlifegrid.com\n"
		...
		case CURLE_SSL_PEER_CERTIFICATE:
			message =
				...
				"to the Support section of the www.openlifegrid.com web site\n"
