	...
	public LLFloater
{
	public:
		...
		void show( std::string content_id, bool open_link_external, bool open_app_url3DXs );

		// Pass raw URL and window title
		// Can be set to handle openlife:///app/ URLs, but this should
		// usually be false.
		void show( std::string start_url, std::string title, bool open_link_external, bool open_app_url3DXs );
