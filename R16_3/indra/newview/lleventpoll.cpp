...
namespace
{
	...
	const S32 MAX_EVENT_POLL_HTTP_ERRORS = 2; // Kirsten alot of things on Opensim/OLG code wont respond 10 retrys is excessive for now reduce to 2 for the interim
