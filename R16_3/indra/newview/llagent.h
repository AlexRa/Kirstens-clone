...
//	BOOL				getLookingAtAvatar() const;
	...
	const std::string getTeleportSourceURL3DX() const { return mTeleportSourceURL3DX; }
...
private:
	...
	std::string		mTeleportSourceURL3DX;			// URL3DX where last TP began.
