...
////////////////////////////////////////////////////////////////////////////////
//
void LLFloaterHtml::show( std::string content_id, bool open_link_external, bool open_app_url3DXs )
{
	...
	show( url, title, open_link_external, open_app_url3DXs );
}

////////////////////////////////////////////////////////////////////////////////
//
void LLFloaterHtml::show( std::string start_url, std::string title, bool open_link_external, bool open_app_url3DXs )
{
	// set the title 
	setTitle( title );
	...
	if ( mWebBrowser )
	{
		mWebBrowser->setOpenAppURL3DXs( open_app_url3DXs );
