...
{
  if (option == 0)
    LLWeb::loadURL("http://openlifegrid.com/WorldPortal/tabid/331/Default.aspx"); //KL Build 160 world Portal
}
	...
	mAllowEdit(allow_edit)
{
	...
	factory_map["OpenLife"] = LLCallbackMap(createPanelAvatarSecondLife, this);
	...
	factory_map["About Me"] = LLCallbackMap(createPanelAvatarFirstLife, this);
